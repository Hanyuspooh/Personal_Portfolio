...
From the graph we can see quite clearly that the fertility rate tends to decrease as a greater percentage of the population goes to school. Women who have received education are more likely to enter the workforce and have lesser children. One explanation for this is the increase in the opportunity cost of childbearing for women who receive primary education. 

```{r, primary school enrollment and fertility rate, fig5, fig.width = 12, fig.height=8}
ggplot(world_bank_extended, aes(x= SE.PRM.NENR, y=SP.DYN.TFRT.IN)) +
  geom_point(size=0.08, alpha=0.3)+
  geom_smooth(method='lm')+
  labs (
    title = "Relationship between fertility rate and primary school enrollment",
    x="Primary School Enrollment (% of children attending)",
    y="Fertility Rate"
  )+
  theme_clean()+
  facet_wrap(~region)
